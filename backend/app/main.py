...
# 迁移：记录中文基础信息对应的 WB 俄语基础信息版本。
from migrations.add_product_knowledge_basic_info_zh_source_hash import migrate_add_product_knowledge_basic_info_zh_source_hash
migrate_add_product_knowledge_basic_info_zh_source_hash()  # 幂等，重复执行无影响
