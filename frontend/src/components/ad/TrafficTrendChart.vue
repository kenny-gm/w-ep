...
function initChart() {
  ...
  const totalVisitors = props.data.map(d => d.total_visitors || 0)
  const adVisitors = props.data.map(d => d.ad_visitors || 0)
    ...
    tooltip: {
      ...
      formatter: function(params) {
        ...
        params.forEach(function(param) {
          ...
          html += '<div style="margin:4px 0;">' + param.marker + ' ' + param.seriesName + ': ' + value.toLocaleString() + ' 访客</div>'
        })
        return html
      }
    },
